...
LIBRESSL_FTP_MIRRORS = [
    ...
    {"host": "openbsd.c3sl.ufpr.br", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirrors.unb.br", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "openbsd.ipacct.com", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "openbsd.cs.toronto.edu", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirror.csclub.uwaterloo.ca", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirrors.dotsrc.org", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirror.one.com", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.eenet.ee", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp2.fr.openbsd.org", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.irisa.fr", "path": "/pub/OpenBSD/LibreSSL/"},
    ...
    {"host": "openbsd.mirror.garr.it", "path": "/mirrors/OpenBSD/LibreSSL/"},
    {"host": "ftp.jaist.ac.jp", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.kddilabs.jp", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.riken.jp", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirror.litnet.lt", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.nluug.nl", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.bit.nl", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirrors.dalenys.com", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.uio.no", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.eu.openbsd.org", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirror.rise.ph", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.icm.edu.pl", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp.man.poznan.pl", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirrors.pidginhost.com", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirror.yandex.ru", "path": "/pub/OpenBSD/LibreSSL/"},
    ...
    {"host": "mirrors.sonic.net", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp3.usa.openbsd.org", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirrors.syringanetworks.net", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirrors.mit.edu", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp4.usa.openbsd.org", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "ftp5.usa.openbsd.org", "path": "/pub/OpenBSD/LibreSSL/"},
    {"host": "mirror.esc7.net", "path": "/pub/OpenBSD/LibreSSL/"},
]
